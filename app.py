...
#Creating the function to accept inputs and creating as 2d array and predicting the result.
...
if _name=="main_":
    ...
    size = col2.number_input("Enter SQFT:",min_value=500,max_value=10000,step=500)
